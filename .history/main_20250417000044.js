...
function displayTodoList() {
  ...
  if (todoList.length === 0) {
    containerDiv.innerHTML = "<h2>Your task board is empty ! </h2>";
  } else {
...
function resetTaskBoard() {
  if (!confirm("Are you sure you want to reset the entire taskboard ? <br> All your tasks will be deleted")) return;
